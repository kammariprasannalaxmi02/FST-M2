...
public class Activity2 {
	...
	public void addNewUserFromFile() throws IOException {
		// Import JSON file
		FileInputStream inputJSON = new FileInputStream("files/userinfo.json");
		...
		response.then().body("message", equalTo("2019"));
	}

	@Test(priority = 2)
	public void getUserInfo() {
		// Import JSON file to write to
		File outputJSON = new File("files/userGETResponse.json");
		...
		// Assertion
		response.then().body("id", equalTo(2019));
